...
export class OrganizationsConfig {
  ...
  constructor(register: any) {
    ...
    let checkCreateOrganizationDetails = ($q: ng.IQService, codenvyOrganization: CodenvyOrganization, codenvyUser: CodenvyUser) => {
      let defer = $q.defer();
    ...
    let createOrganizationLocationProvider = {
      ...
      resolve: {
        check: ['$q', 'codenvyOrganization', 'codenvyUser', checkCreateOrganizationDetails]
      }
    };

    // config routes
    register.app.config(($routeProvider: ng.route.IRouteProvider) => {
      $routeProvider.accessWhen('/admin/organizations', {
        title: 'organizations',
        ...
        .accessWhen('/admin/create-organizations', createOrganizationLocationProvider)
        .accessWhen('/admin/create-organizations/:parentQualifiedName*', createOrganizationLocationProvider)
